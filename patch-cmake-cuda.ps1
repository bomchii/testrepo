...
# Variante CUDA 12 + AVX2 de patch-cmake.ps1.
# Genera s2-cuda.exe compilado con ggml-cuda (sm_86, RTX 30xx Ampere).
...
set_target_properties(s2-cuda PROPERTIES OUTPUT_NAME "s2-cuda")
